...
public class SpasPageDTO implements Serializable {
    ...
    public SpasPageDTO(Page<Spas> page, PagedModel.PageMetadata pageMetadata, List<Link> links) {
        ...
        List<SpasDTO> spasList = page.getContent().stream()
                .map(SpasDTO::new)
                .collect(Collectors.toList());
        this.embedded = new Embedded(spasList);
    ...
    public static class Embedded implements Serializable {
        ...
        @JsonProperty("spasList")
        private List<SpasDTO> spasList;
        
        public Embedded() {
            this.spasList = new ArrayList<>();
        }
        
        public Embedded(List<SpasDTO> spasList) {
            this.spasList = spasList;
        }
    }
