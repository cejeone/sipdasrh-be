...
public class Kegiatan implements Serializable {
    ...
    @ManyToOne
    @JoinColumn(name = "pemegang_ijin", referencedColumnName = "id")
    private Lov pemegangIjin;

    @ManyToOne
    @JoinColumn(name = "peruntukan", referencedColumnName = "id")
    ...
    @ManyToOne
    @JoinColumn(name = "jenis_ijin", referencedColumnName = "id")
    ...
    @Column(name = "luas_sesuai_sk_pak_ha")
    private Double luasSesuaiSkPakHa;
