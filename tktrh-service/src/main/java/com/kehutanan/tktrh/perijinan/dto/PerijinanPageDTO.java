...
@Data
public class PerijinanPageDTO implements Serializable {
     ...
     */
    public PerijinanPageDTO() {
        this.embedded = new Embedded(new ArrayList<>());
        this.links = new HashMap<>();
        this.page = new PageMetadata(0, 0, 0, 0);
    }
    
    public PerijinanPageDTO(Page<Perijinan> page, PagedModel.PageMetadata pageMetadata, List<Link> links) {
        // Set embedded content
        List<PerijinanDTO> perijinanList = page.getContent().stream()
                .map(PerijinanDTO::new)
                .collect(Collectors.toList());
        this.embedded = new Embedded(perijinanList);
    ...
    public static class Embedded implements Serializable {
        ...
        @JsonProperty("perijinanList")
        private List<PerijinanDTO> perijinanList;
        
        public Embedded() {
            this.perijinanList = new ArrayList<>();
        }
        
        public Embedded(List<PerijinanDTO> perijinanList) {
            this.perijinanList = perijinanList;
        }
    }
