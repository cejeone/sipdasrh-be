...
public class KegiatanLokusFileDTO implements Serializable {
    ...
    public KegiatanLokusFileDTO(KegiatanLokusProposalPdf pdf) {
        this.id = pdf.getId();
    ...
    public KegiatanLokusFileDTO(KegiatanLokusLokasiPdf pdf) {
        this.id = pdf.getId();
        this.namaAsli = pdf.getNamaAsli();
        this.namaFile = pdf.getNamaFile();
        this.pathFile = pdf.getPathFile();
    ...
    public KegiatanLokusFileDTO(KegiatanLokusBangunanPdf pdf) {
        this.id = pdf.getId();
        this.namaAsli = pdf.getNamaAsli();
        this.namaFile = pdf.getNamaFile();
        this.pathFile = pdf.getPathFile();
