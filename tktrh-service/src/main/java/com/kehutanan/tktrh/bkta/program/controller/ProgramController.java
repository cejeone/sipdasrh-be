...
import com.kehutanan.tktrh.master.service.Eselon2Service;
...
@RestController("bktaProgramController")  // Add unique name
@RequestMapping("/api/bkta/program")
public class ProgramController {
    ...
    public ResponseEntity<ProgramPageDTO> getAllPrograms(
        ...
        if ((namaProgram != null && !namaProgram.isEmpty()) ||
            ...
            programPage = service.findByFiltersWithCache(namaProgram, tahun, status, pageable, baseUrl);
        } else {
    ...
    public ResponseEntity<Program> createProgram(
            ...
            @RequestPart(required = false) String targetGp,
            @RequestPart(required = false) String targetDpn,
        ...
        try {
            ...
            if (targetGp != null && !targetGp.isEmpty()) {
                newProgram.setTargetGp(Integer.parseInt(targetGp));
            }
            
            if (targetDpn != null && !targetDpn.isEmpty()) {
                newProgram.setTargetDpn(Integer.parseInt(targetDpn));
            }
    ...
    public ResponseEntity<Program> updateProgram(
        ...
        try {
            ...
            if (targetGp != null && !targetGp.isEmpty()) {
                existingProgram.setTargetGp(Integer.parseInt(targetGp));
            }
            
            if (targetDpn != null && !targetDpn.isEmpty()) {
                existingProgram.setTargetDpn(Integer.parseInt(targetDpn));
            }
            ...
            if (eselon2Id != null && !eselon2Id.isEmpty()) {
                Long eselon2IdLong = Long.parseLong(eselon2Id);
                Eselon2 eselon2 = eselon2Service.findById(eselon2IdLong);
                existingProgram.setEselon2(eselon2);
            }
