package com.kehutanan.tktrh.bkta.monev.service.impl;
...
import com.kehutanan.tktrh.bkta.monev.repository.MonevPusatRepository;
import com.kehutanan.tktrh.bkta.monev.service.MonevPusatService;

import jakarta.persistence.EntityNotFoundException;

@Service("bktaMonevPusatService")
public class MonevPusatServiceImpl implements MonevPusatService {
    ...
    public MonevPusat update(Long id, MonevPusat monevPusat) {
        ...
        if (!repository.existsById(id)) {
            throw new EntityNotFoundException("MonevPusat not found with id: " + id);
        }
        return repository.save(monevPusat);
    }
    ...
    @Override
    public MonevPusatPageDTO findByFiltersWithCache(String namaProgram, String keterangan, List<String> bpdasList,
        ...
        // Add filter for bpdas id list if provided
