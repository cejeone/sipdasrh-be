...
@Data
public class KegiatanBastRehabDasPageDTO implements Serializable {
     ...
     */
    public KegiatanBastRehabDasPageDTO() {
        this.embedded = new Embedded(new ArrayList<>());
        this.links = new HashMap<>();
        this.page = new PageMetadata(0, 0, 0, 0);
    }
    
    public KegiatanBastRehabDasPageDTO(Page<KegiatanBastRehabDas> page, PagedModel.PageMetadata pageMetadata, List<Link> links) {
        // Set embedded content
        List<KegiatanBastRehabDasDTO> kegiatanBastRehabDasList = page.getContent().stream()
                .map(KegiatanBastRehabDasDTO::new)
                .collect(Collectors.toList());
        this.embedded = new Embedded(kegiatanBastRehabDasList);
    ...
    public static class Embedded implements Serializable {
        ...
        @JsonProperty("kegiatanBastRehabDasList")
        private List<KegiatanBastRehabDasDTO> kegiatanBastRehabDasList;
        
        public Embedded() {
            this.kegiatanBastRehabDasList = new ArrayList<>();
        }
        
        public Embedded(List<KegiatanBastRehabDasDTO> kegiatanBastRehabDasList) {
            this.kegiatanBastRehabDasList = kegiatanBastRehabDasList;
        }
    }
