...
@Data
public class KegiatanFungsiKawasanRehabPageDTO implements Serializable {
     ...
     */
    public KegiatanFungsiKawasanRehabPageDTO() {
        this.embedded = new Embedded(new ArrayList<>());
        this.links = new HashMap<>();
        this.page = new PageMetadata(0, 0, 0, 0);
    }
    
    public KegiatanFungsiKawasanRehabPageDTO(Page<KegiatanFungsiKawasanRehab> page, PagedModel.PageMetadata pageMetadata, List<Link> links) {
        // Set embedded content
        List<KegiatanFungsiKawasanRehabDTO> kegiatanFungsiKawasanRehabList = page.getContent().stream()
                .map(KegiatanFungsiKawasanRehabDTO::new)
                .collect(Collectors.toList());
        this.embedded = new Embedded(kegiatanFungsiKawasanRehabList);
    ...
    public static class Embedded implements Serializable {
        ...
        @JsonProperty("kegiatanFungsiKawasanRehabList")
        private List<KegiatanFungsiKawasanRehabDTO> kegiatanFungsiKawasanRehabList;
        
        public Embedded() {
            this.kegiatanFungsiKawasanRehabList = new ArrayList<>();
        }
        
        public Embedded(List<KegiatanFungsiKawasanRehabDTO> kegiatanFungsiKawasanRehabList) {
            this.kegiatanFungsiKawasanRehabList = kegiatanFungsiKawasanRehabList;
        }
    }
