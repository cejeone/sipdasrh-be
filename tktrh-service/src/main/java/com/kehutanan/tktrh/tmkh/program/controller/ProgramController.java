...
@RestController("tmkhProgramController")  // Add unique name
@RequestMapping("/api/tmkh/program")
public class ProgramController {
    ...
    public ResponseEntity<ProgramPageDTO> getAllProgram(
        ...
        if ((nama != null && !nama.isEmpty()) ||
            ...
            programPage = service.findByFiltersWithCache(nama, anggaran, status, pageable, baseUrl);
        } else {
    ...
    public ResponseEntity<Program> createProgram(
        ...
        try {
            ...
            if (statusId != null && !statusId.isEmpty()) {
                Long status_id = Long.parseLong(statusId);
                Lov status = lovService.findById(status_id);
