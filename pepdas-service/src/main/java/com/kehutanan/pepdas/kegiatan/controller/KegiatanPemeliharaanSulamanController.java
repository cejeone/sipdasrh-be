...
import com.kehutanan.pepdas.kegiatan.dto.KegiatanPemeliharaanSulamanDto;
...
import com.kehutanan.pepdas.kegiatan.service.KegiatanPemeliharaanSulamanService;
...
public class KegiatanPemeliharaanSulamanController {
        ...
        public KegiatanPemeliharaanSulamanController(
                        KegiatanPemeliharaanSulamanService kegiatanPemeliharaanSulamanService,
        ...
        public ResponseEntity<PagedModel<EntityModel<KegiatanPemeliharaanSulaman>>> getAll(
                        ...
                        @Parameter(description = "Search term for kategori, kondisiTanaman, namaBibit or keterangan") @RequestParam(required = false) String search) {

                Pageable pageable = PageRequest.of(page, size);
                PagedModel<EntityModel<KegiatanPemeliharaanSulaman>> pagedModel = kegiatanPemeliharaanSulamanService
                                .findAll(
                                                KegiatanId, search, pageable, pagedResourcesAssembler);
        ...
        public ResponseEntity<KegiatanPemeliharaanSulaman> findById(
                ...
                KegiatanPemeliharaanSulaman kegiatanPemeliharaanSulaman = kegiatanPemeliharaanSulamanService
                                .findById(id);
        ...
        public ResponseEntity<KegiatanPemeliharaanSulaman> createWithFormData(
                ...
                kegiatanPemeliharaanSulaman
                                .setJumlahTanamanHidup(kegiatanPemeliharaanSulamanDto.getJumlahTanamanHidup());
                kegiatanPemeliharaanSulaman
                                .setJumlahHokPerempuan(kegiatanPemeliharaanSulamanDto.getJumlahHokPerempuan());
                ...
                kegiatanPemeliharaanSulaman.setKegiatan(kegiatanRepository
                                .findById(kegiatanPemeliharaanSulamanDto.getKegiatanId())
                                .orElseThrow(() -> new EntityNotFoundException(
                                                "Kegiatan not found with ID: "
                                                                + kegiatanPemeliharaanSulamanDto.getKegiatanId())));

                KegiatanPemeliharaanSulaman created = kegiatanPemeliharaanSulamanService
                                .create(kegiatanPemeliharaanSulaman);
        ...
        public ResponseEntity<KegiatanPemeliharaanSulaman> update(
                ...
                KegiatanPemeliharaanSulaman updated = kegiatanPemeliharaanSulamanService.update(id,
                                kegiatanPemeliharaanSulamanDto);
