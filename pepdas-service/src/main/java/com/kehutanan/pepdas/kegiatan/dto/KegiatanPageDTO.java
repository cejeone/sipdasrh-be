...
public class KegiatanPageDTO implements Serializable {
    ...
    public KegiatanPageDTO(Page<Kegiatan> page, PagedModel.PageMetadata pageMetadata, List<Link> links) {
        ...
        List<KegiatanDTO> kegiatanList = page.getContent().stream()
                .map(KegiatanDTO::new)
                .collect(Collectors.toList());
        this.embedded = new Embedded(kegiatanList);
    ...
    public static class Embedded implements Serializable {
        ...
        public Embedded(List<KegiatanDTO> kegiatanList) {
