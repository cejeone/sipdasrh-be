...
@Data
public class PemantauanDasPageDTO implements Serializable {
     ...
     */
    public PemantauanDasPageDTO() {
        this.embedded = new Embedded(new ArrayList<>());
        this.links = new HashMap<>();
        this.page = new PageMetadata(0, 0, 0, 0);
    }
    
    public PemantauanDasPageDTO(Page<PemantauanDas> page, PagedModel.PageMetadata pageMetadata, List<Link> links) {
        // Set embedded content
        List<PemantauanDasDTO> pemantauanDasList = page.getContent().stream()
                .map(PemantauanDasDTO::new)
                .collect(Collectors.toList());
        this.embedded = new Embedded(pemantauanDasList);
    ...
    public static class Embedded implements Serializable {
        ...
        @JsonProperty("pemantauanDasList")
        private List<PemantauanDasDTO> pemantauanDasList;
        
        public Embedded() {
            this.pemantauanDasList = new ArrayList<>();
        }
        
        public Embedded(List<PemantauanDasDTO> pemantauanDasList) {
            this.pemantauanDasList = pemantauanDasList;
        }
    }
