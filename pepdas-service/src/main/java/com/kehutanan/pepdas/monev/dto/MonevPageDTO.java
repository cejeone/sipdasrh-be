...
@Data
public class MonevPageDTO implements Serializable {
    ...
    public MonevPageDTO(Page<Monev> page, PagedModel.PageMetadata pageMetadata, List<Link> links) {
        // Set embedded content
        List<MonevDTO> monevList = page.getContent().stream()
                .map(MonevDTO::new)
                .collect(Collectors.toList());
        this.embedded = new Embedded(monevList);
    ...
    public static class Embedded implements Serializable {
        ...
        @JsonProperty("monevList")
        private List<MonevDTO> monevList;
        
        public Embedded() {
            this.monevList = new ArrayList<>();
        }
        
        public Embedded(List<MonevDTO> monevList) {
