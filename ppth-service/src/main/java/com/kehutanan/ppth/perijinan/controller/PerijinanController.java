package com.kehutanan.ppth.perijinan.controller;
...
import com.kehutanan.ppth.master.service.PelakuUsahaService;
...
public class PerijinanController {
    ...
    public ResponseEntity<Perijinan> createPerijinan(
            ...
            @RequestPart(required = false) String catatanDokumenPerijinan,
            @RequestPart(required = false) String catatanDokumenSertifikat,
        ...
        try {
            ...
            newPerijinan.setCatatanDokumenPerijinan(catatanDokumenPerijinan);
            newPerijinan.setCatatanDokumenSertifikat(catatanDokumenSertifikat);
    ...
    public ResponseEntity<Perijinan> updatePerijinan(
        ...
        try {
            ...
            if (catatanDokumenPerijinan != null) {
                existingPerijinan.setCatatanDokumenPerijinan(catatanDokumenPerijinan);
            }
            
            if (catatanDokumenSertifikat != null) {
                existingPerijinan.setCatatanDokumenPerijinan(catatanDokumenSertifikat);
            }
