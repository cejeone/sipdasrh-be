package com.kehutanan.ppth.penghijauan.monev.dto;
...
@Data
public class MonevPusatPageDTO implements Serializable {
     ...
     */
    public MonevPusatPageDTO() {
        this.embedded = new Embedded(new ArrayList<>());
        this.links = new HashMap<>();
        this.page = new PageMetadata(0, 0, 0, 0);
    }
    
    public MonevPusatPageDTO(Page<MonevPusat> page, PagedModel.PageMetadata pageMetadata, List<Link> links) {
        // Set embedded content
        List<MonevPusatDTO> monevPusatList = page.getContent().stream()
                .map(MonevPusatDTO::new)
                .collect(Collectors.toList());
        this.embedded = new Embedded(monevPusatList);
    ...
    public static class Embedded implements Serializable {
        ...
        @JsonProperty("monevPusatList")
        private List<MonevPusatDTO> monevPusatList;
        
        public Embedded() {
            this.monevPusatList = new ArrayList<>();
        }
        
        public Embedded(List<MonevPusatDTO> monevPusatList) {
            this.monevPusatList = monevPusatList;
        }
    }
