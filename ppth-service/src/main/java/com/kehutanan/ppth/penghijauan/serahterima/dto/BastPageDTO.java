package com.kehutanan.ppth.penghijauan.serahterima.dto;
...
@Data
public class BastPageDTO implements Serializable {
    ...
    public BastPageDTO(Page<Bast> page, PagedModel.PageMetadata pageMetadata, List<Link> links) {
        // Set embedded content
        List<BastDTO> bastList = page.getContent().stream()
                .map(BastDTO::new)
                .collect(Collectors.toList());
        this.embedded = new Embedded(bastList);
    ...
    public static class Embedded implements Serializable {
        ...
        @JsonProperty("bastList")
        private List<BastDTO> bastList;
        
        public Embedded() {
            this.bastList = new ArrayList<>();
        }
        
        public Embedded(List<BastDTO> bastList) {
