package com.kehutanan.superadmin.generic;
...
@Slf4j
@Service
public class MinioGenericService {
    ...
    /**
     * Sets the folder prefix for all file operations.
     * The prefix will be prepended to all object names in the bucket.
     * Make sure to include a trailing slash if needed (e.g., "folder/")
     * 
     * @param folderPrefix the folder prefix to use
     */
    public void setFolderPrefix(String folderPrefix) {
        if (folderPrefix == null) {
            this.FOLDER_PREFIX = "";
        } else {
            this.FOLDER_PREFIX = folderPrefix;
            // Ensure the folder prefix ends with a slash if not empty
    ...
    /**
     * Gets the current folder prefix used for MinIO operations
     * 
     * @return the current folder prefix
     */
    public String getFolderPrefix() {
        return FOLDER_PREFIX;
    }

    public MinioGenericService(
