...
public class ProgramServiceImpl implements ProgramService {
    ...
    @Override
    @Cacheable(value = "rm_programCache", key = "#id")
    ...
    @Override
    @CacheEvict(value = { "rm_programCache", "rm_programPageCache", "rm_programFilterCache",
    ...
    @Override
    @CachePut(value = "rm_programCache", key = "#id")
    ...
    @Override
    @Cacheable(value = "rm_programPageCache", key = "#pageable.pageNumber + '_' + #pageable.pageSize + '_' + #pageable.sort")
    ...
    @Override
    @Cacheable(value = "rm_programFilterCache", key = "{#nama, #eselon, #pageable.pageNumber, #pageable.pageSize, #pageable.sort}")
    ...
    @Override
    @Cacheable(value = "rm_programSearchCache", key = "{#keyWord, #pageable.pageNumber, #pageable.pageSize, #pageable.sort}")
