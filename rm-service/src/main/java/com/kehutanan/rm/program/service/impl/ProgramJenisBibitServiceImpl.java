package com.kehutanan.rm.program.service.impl;
...
public class ProgramJenisBibitServiceImpl implements ProgramJenisBibitService {
    ...
    @Override
    @Cacheable(value = "rm_programJenisBibitCache", key = "#id")
    ...
    @Override
    @CacheEvict(value = { "rm_programJenisBibitCache", "rm_programJenisBibitPageCache",
            "rm_programJenisBibitFilterCache",
            "rm_programJenisBibitSearchCache" ,"rm_programCache", "rm_programPageCache", "rm_programFilterCache",
            "rm_programSearchCache" }, allEntries = true, beforeInvocation = true)
    public ProgramJenisBibit save(ProgramJenisBibit programJenisBibit) {
        return repository.save(programJenisBibit);
    }

    @Override
    @CachePut(value = "rm_programJenisBibitCache", key = "#id")
    ...
    @Override
    @Cacheable(value = "rm_programJenisBibitPageCache", key = "#pageable.pageNumber + '_' + #pageable.pageSize + '_' + #pageable.sort")
    ...
    @Override
    @Cacheable(value = "rm_programJenisBibitFilterCache", key = "{#programId, #namaBibit, #kategori, #pageable.pageNumber, #pageable.pageSize, #pageable.sort}")
    ...
    @Override
    @Cacheable(value = "rm_programJenisBibitSearchCache", key = "{#programId, #keyWord, #pageable.pageNumber, #pageable.pageSize, #pageable.sort}")
