...
public class ProgramSkemaController {
    ...
    public ResponseEntity<ProgramSkemaPageDTO> searchProgramSkema(
            ...
            HttpServletRequest request) {
        Pageable pageable = PageRequest.of(page, size);
        ProgramSkemaPageDTO programSkemaPage = service.searchWithCache(programId, keyWord, pageable, request.getRequestURL().toString());
        return ResponseEntity.ok(programSkemaPage);
    }
    ...
    public ResponseEntity<ProgramSkema> createProgramSkema(
            ...
            @RequestPart(required = false) String skema,
        ...
        try {
            ...
            // Set other fields
            programSkema.setSkema(Integer.parseInt(skema));
    ...
    public ResponseEntity<ProgramSkema> updateProgramSkema(
        ...
        try {
            ...
            // Update other fields
            existingProgramSkema.setSkema(Integer.parseInt(skema));
