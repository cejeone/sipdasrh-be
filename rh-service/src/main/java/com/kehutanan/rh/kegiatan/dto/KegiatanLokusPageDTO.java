...
public class KegiatanLokusPageDTO implements Serializable {
    ...
    public KegiatanLokusPageDTO(Page<KegiatanLokus> page, PagedModel.PageMetadata pageMetadata, List<Link> links) {
        ...
        List<KegiatanLokusDTO> kegiatanLokusList = page.getContent().stream()
                .map(KegiatanLokusDTO::new)
                .collect(Collectors.toList());
        this.embedded = new Embedded(kegiatanLokusList);
    ...
    public static class Embedded implements Serializable {
        ...
        @JsonProperty("kegiatanLokusList")
        private List<KegiatanLokusDTO> kegiatanLokusList;
        
        public Embedded() {
            this.kegiatanLokusList = new ArrayList<>();
        }
        
        public Embedded(List<KegiatanLokusDTO> kegiatanLokusList) {
            this.kegiatanLokusList = kegiatanLokusList;
        }
    }
